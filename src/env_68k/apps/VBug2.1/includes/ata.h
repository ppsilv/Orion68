...
#define IO_BASE 0x00FF4400
#define IDE_BASE IO_BASE

//volatile uint8_t *ide_8bits = (volatile uint8_t *)0xFF4400;
/*
#define REG_DATA       0   // 0xFF4400 (Aqui você só lê/escreve como uint16_t!)
#define REG_ERROR      2   // 0xFF4402 -> Endereço par puro!
#define REG_SECTOR_CNT 4   // 0xFF4404 -> Endereço par puro!
#define REG_LBA_LOW    6   // 0xFF4406 -> Endereço par puro!
#define REG_LBA_MID    8   // 0xFF4408 -> Endereço par puro!
#define REG_LBA_HIGH   10  // 0xFF440A -> Endereço par puro!
#define REG_DEVSEL     12  // 0xFF440C -> Endereço par puro!
#define REG_COMMAND    14  // 0xFF440E -> Endereço par puro! / STATUS na leitura
#define REG_ALT_STATUS 28  // 0xFF441C -> Endereço par puro! (14 * 2)
*/
