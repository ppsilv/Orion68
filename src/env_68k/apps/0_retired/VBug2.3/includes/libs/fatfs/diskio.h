...
#define	IDE_BASE 0x00FF4400

#define	ATA_REG_DATA	        *((volatile uint16_t *) (IDE_BASE + 0x00 ))            /* Data Register (R/W) */
#define	ATA_REG_DATA_BYTE       *((volatile uint8_t  *) (IDE_BASE + 0x00 + 1))            /* Data Register (R/W) */
#define	ATA_REG_ERROR   	    *((volatile uint8_t  *) (IDE_BASE + 0x02 + 1))            /* Error Register (R) */
#define	ATA_REG_PRECOMP	        *((volatile uint8_t  *) (IDE_BASE + 0x02 + 1))            /* Write Precomp register (W) */
#define	ATA_REG_SECTOR_COUNT	*((volatile uint8_t  *) (IDE_BASE + 0x04 + 1))            /* Sector Count (R/W) */
#define	ATA_REG_SECTOR_NUMBER   *((volatile uint8_t  *) (IDE_BASE + 0x06 + 1))            /* Sector Number (LBA bits 0-7) (R/W) */
#define	ATA_REG_CYLINDER_LOW    *((volatile uint8_t  *) (IDE_BASE + 0x08 + 1))            /* Cylinder Low (LBA bits 8-15) (R/W) */
#define	ATA_REG_CYLINDER_HIGH   *((volatile uint8_t  *) (IDE_BASE + 0x0A + 1))            /* Cylinder High (LBA bits 16-23) (R/W) */
#define	ATA_REG_DRIVE_HEAD      *((volatile uint8_t  *) (IDE_BASE + 0x0C + 1))            /* Device/Head Register (R/W) */
#define	ATA_REG_STATUS	        *((volatile uint8_t  *) (IDE_BASE + 0x0E + 1))            /* Status Register (R) */
#define	ATA_REG_COMMAND	        *((volatile uint8_t  *) (IDE_BASE + 0x0E + 1))            /* Command Register (W) */
#define ATA_REG_ALT_STATUS      *((volatile uint8_t  *) (IDE_BASE + 0x8C + 1))            /* Alternate Status (R) */
#define ATA_REG_DRIVE_CONTROL   *((volatile uint8_t  *) (IDE_BASE + 0x8C + 1))            /* Interrupt/Reset Register (W) */
#define ATA_REG_DRIVE_ADDR      *((volatile uint8_t  *) (IDE_BASE + 0x8E + 1))            /* Drive Address (R) */
