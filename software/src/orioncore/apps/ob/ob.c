...
//static uint8_t *raw_buf= (uint8_t *)0xA0000;//[MAX_FW_SIZE];
...
int main(int argc, char *argv[])
{
    ...
    printf("Orionbur compiled for orioncore\nide");
    video_puts("Calling do_ideinit\n");
    do_ideinit();
    ...
    printf("Reading file: %s sizeof %d\n", argv[1], fh.size);
    ...
    video_puts("cpu_disable_interrupts");
    ...
    cpu_restore_interrupts(old_sr);
    video_puts("cpu_enabled_interrupts");
